...
class Billing:
    def __init__(self, master):
        ...
        # ===============TITLE==========
        self.lblTitle = Label(self.frame, text="BILLING WINDOW", font="Helvetica 20 bold", bg="#E9ECF3")
        ...
        # ===========LABELS=============
        self.total_sum_label = Label(self.LoginFrame, text="TOTAL AMOUNT OUTSTANDING", font="Helvetica 14 bold", bg="#E9ECF3", bd=22)
        self.total_sum_label.grid(row=6, column=0)

        self.total_sum_value = Label(self.LoginFrame, text="", font="Helvetica 14 bold", bg="#E9ECF3", bd=22)
        self.total_sum_value.grid(row=6, column=1)
        self.lblpid = Label(self.LoginFrame, text="PATIENT ID", font="Helvetica 14 bold", bg="#E9ECF3", bd=22)
        ...
        self.lbldid = Label(self.LoginFrame, text="DATE DISCHARGED", font="Helvetica 14 bold", bg="#E9ECF3", bd=22)
        ...
        self.lbltreat = Label(self.LoginFrame, text="TREATMENT", font="Helvetica 14 bold", bg="#E9ECF3", bd=22)
        ...
        self.lblcode_t1 = Label(self.LoginFrame, text="TREATMENT CODE", font="Helvetica 14 bold", bg="#E9ECF3", bd=22)
        ...
        self.lblap = Label(self.LoginFrame, text="TREATMENT COST ₹", font="Helvetica 14 bold", bg="#E9ECF3", bd=22)
        ...
        self.lblmed = Label(self.LoginFrame, text="MEDICINE", font="Helvetica 14 bold", bg="#E9ECF3", bd=22)
        ...
        self.med_t1 = Label(self.LoginFrame, text="MEDICINE QUANTITY", font="Helvetica 14 bold", bg="#E9ECF3", bd=22)
        ...
        self.lblapd = Label(self.LoginFrame, text="MEDICINE PRICE ₹", font="Helvetica 14 bold", bg="#E9ECF3", bd=22)
        ...
        self.lblroom = Label(self.LoginFrame, text="ROOM NUMBER", font="Helvetica 14 bold", bg="#E9ECF3", bd=22)
        ...
        self.lblprice = Label(self.LoginFrame, text="ROOM PRICE ₹", font="Helvetica 14 bold", bg="#E9ECF3", bd=22)
